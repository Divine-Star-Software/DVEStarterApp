...
import { RenderPlayer } from "@divinevoxel/ecs/Player/Render";
    ...
    */
    {
      ...
      action: () => {
        ...
        DVER.worldComm.runTasks<PlaceVoxelTask>(PlayerTasks.Place, [
    ...
    },
    {
      ...
      action: () => {
        if (!player.active) return;
        player.picker.setPickNormals();
        DVER.worldComm.runTasks<RemoveVoxelTask>(PlayerTasks.Remove, [
