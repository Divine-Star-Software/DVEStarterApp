...
export function RegisterVoxelContrusctors(DVEC: DivineVoxelEngineConstructor) {
  const voxelConstructors = DVEC.builder.constructors;
  const defaults = voxelConstructors.defaults;
  ...
  voxelConstructors.registerVoxel([
    ...
    defaults.box.simple("dve_dream_leaves", ["#dve_flora", "dve_dream_leaves"]),
    //dread
